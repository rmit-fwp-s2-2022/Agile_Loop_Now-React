                ...
                <Container maxW="sm" boxShadow={"2xl"} rounded={"lg"} borderWidth={1}>
                    ...
                    <Stack  spacing={5} p={10} divider={<StackDivider borderColor='gray.200' />}>
                        <Formik
                            ...
                            {(formik) => (
                                <Box>
                                    <Text color={'gray.500'} fontSize={'xs'}>NAME</Text>
                                    <FormControl isInvalid={formik.errors.name}>
                                        <InputGroup>
                                                <Editable fontSize={'lg'} fontWeight={400} isPreviewFocusable={false} value={formik.values.name} onSubmit={formik.handleSubmit}>
                                                    <EditablePreview/>
                            ...
                            {(formik) => (
                                <Box>
                                    ...
                                    <FormControl isInvalid={formik.errors.email} >
                                        <InputGroup>
                                                <Editable fontSize={'lg'} fontWeight={400} isPreviewFocusable={false} value={formik.values.email} onSubmit={formik.handleSubmit}>
                                                    <EditablePreview/>
                        ...
                        <Box> 
                            <Text color={'gray.500'} fontSize={'xs'}>JOINED ON</Text>
                            <Text fontSize={'lg'} fontWeight={400}>{Intl.DateTimeFormat('en-GB', 
                            { weekday: 'short', month: 'short', day: 'numeric', year: 'numeric'}).format(new Date(user.joinedOn))}</Text>
                        </Box>
                    </Stack>
                        ...
                        >
                            ...
                            <AlertDialogContent>
                                ...
                                <AlertDialogBody>
                                    ...
                                    </Box> : <Text>Confirm to delete your account</Text>}
