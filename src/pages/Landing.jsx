...
import {Box, SimpleGrid, Heading, Text, Button, Flex, Image} from "@chakra-ui/react";
      ...
      <SimpleGrid columns={2} minH={'80vh'} p={180}  spacing='60px'>
        <Box>
          ...
          <Text color={'gray.500'} fontSize={20} pt={30}>
              Loop Agile aims to make communication between colleagues a smoother experience. 
              It is a platform designed to connect users all around the world by enabling community
              of practice. 
          </Text>
          <Box pt={30}>
            <Button
